...
window.onload = function() {
  ...
  var deleteCols = function deleteCols() {
    $('.highlight-deletion').addClass('nowrap');
    setTimeout(animateDeletion, 10);
  }

  var animateInsertion = function animateInsertion() {
    $('.nowrap').addClass('highlight-insertion');
    $('.nowrap').removeClass('nowrap hidden fade');
  }
  ...
  var deleteHeaders = function deleteHeaders() {
    var colIdx = 2;
    $('tr:first-child td').slice(colIdx).addClass('nowrap hidden fade');
    function remove() {
      $('.fade').remove();
    }
    setTimeout(remove, 400);
  ...
  var deleteCells = function deleteCells() {
    var h1 = $('tr:nth-child(3) td:nth-child(3)').clone().removeClass().addClass('nowrap hidden fade');
    var h2 = $('tr:nth-child(3) td:nth-child(4)').clone().removeClass().addClass('nowrap hidden fade');
  ...
  $('#play').click(function play() {
    console.log('playing pivot demo');
    intervalID = window.setInterval(step, 1200);
  ...
  $('#pause').click(function pause() {
    console.log('pausing pivot demo');
    stop();
  ...
  $('#reset').click(function reset() {
    console.log('resetting pivot demo');
    $('.task-table').replaceWith(table);
    table = table.clone();
    i = 0;
    $('#play').prop('disabled', false);
    $('#pause').prop('disabled', true);
